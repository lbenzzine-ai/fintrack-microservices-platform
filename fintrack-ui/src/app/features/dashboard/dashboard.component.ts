  ...
  template: `
    <div class="page-header">
      <div>
        ...
        <div class="text-muted">Manage your accounts, send money and track your transaction history.</div>
      </div>
    ...
    <div class="grid grid-cols-4 gap-3 mb-6">
      <div class="stat-card">
        ...
        <div class="text-muted-mt">Across {{ accounts.length }} account(s)</div>
      </div>
      <div class="stat-card">
      ...
      <div class="stat-card">
        ...
        <div class="text-muted-mt">{{ recentTransactions[0]?.description || 'No activity' }}</div>
      </div>
      <div class="stat-card">
    ...
    <div class="card">
      ...
      <div *ngIf="!loading && recentTransactions.length === 0" class="text-muted text-sm py-8 text-center">
        No transactions yet.
