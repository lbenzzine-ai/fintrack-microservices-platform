...
class AuthServiceTest {
    ...
    class Login {
        ...
        void login_validCredentialsByEmail_returnsTokens() {
            ...
            assertThat(out.accessToken()).isEqualTo("access-tok");
            assertThat(out.refreshToken()).isEqualTo("refresh-tok");
            assertThat(out.expiresAt()).isEqualTo(exp);
            assertThat(out.user()).isSameAs(mapped);
        }
