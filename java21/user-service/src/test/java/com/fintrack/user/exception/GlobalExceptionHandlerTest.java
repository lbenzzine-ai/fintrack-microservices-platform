...
class GlobalExceptionHandlerTest {
    ...
    void handleApi_mapsStatusCodeMessageAndPath() {
        ...
        assertThat(body.code()).isEqualTo("USER_EMAIL_EXISTS");
        assertThat(body.message()).contains("a@b.com");
        assertThat(body.path()).isEqualTo("/api/users/me");
    ...
    void handleApi_invalidCredentials_mapsTo401() {
        ...
        assertThat(resp.getBody().code()).isEqualTo("AUTH_INVALID_CREDENTIALS");
    }
    ...
    void handleApi_userNotFound_mapsTo404() {
        ...
        assertThat(resp.getBody().code()).isEqualTo("USER_NOT_FOUND");
        assertThat(resp.getBody().message()).contains("uuid-x");
    }
    ...
    void handleApi_usernameExists_mapsTo409() {
        ...
        assertThat(resp.getStatusCode()).isEqualTo(HttpStatus.CONFLICT);
        assertThat(resp.getBody().code()).isEqualTo("USER_USERNAME_EXISTS");
    }
