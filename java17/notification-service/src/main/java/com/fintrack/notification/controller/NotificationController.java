...
public class NotificationController {
    ...
    public NotificationPreference upsertPref(@PathVariable String userUuid,
        ...
        NotificationPreference incoming = NotificationPreference.builder()
                .userUuid(userUuid)
                .emailEnabled(Boolean.TRUE.equals(req.getEmailEnabled()))
                .smsEnabled(Boolean.TRUE.equals(req.getSmsEnabled()))
                .pushEnabled(Boolean.TRUE.equals(req.getPushEnabled()))
