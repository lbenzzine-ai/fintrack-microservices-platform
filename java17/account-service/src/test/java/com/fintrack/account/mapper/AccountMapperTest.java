...
class AccountMapperTest {
    ...
    // MapStruct-generated impl lives next to the interface at compile time.
    ...
    void toResponse_copies_all_fields() {
        ...
        assertThat(r.getUuid()).isEqualTo("uuid-1");
        assertThat(r.getUserUuid()).isEqualTo("user-1");
        assertThat(r.getBalance()).isEqualByComparingTo("123.45");
        assertThat(r.getCurrencyCode()).isEqualTo("EUR");
        assertThat(r.getStatus()).isEqualTo(AccountStatus.ACTIVE);
    ...
    void toBalance_maps_uuid_to_accountUuid() {
        ...
        assertThat(r.getAccountUuid()).isEqualTo("uuid-2");
        assertThat(r.getBalance()).isEqualByComparingTo("999.00");
