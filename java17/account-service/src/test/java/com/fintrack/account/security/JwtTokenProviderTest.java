...
class JwtTokenProviderTest {
    ...
    // 256-bit (32-byte) random-looking secret, base64 encoded — same shape as in production config.
    ...
    void parse_expired_token_returns_empty() {
        String token = tokenWith(ISSUER, -10_000, "u", List.of("USER")); // already expired
    ...
    void parse_null_returns_empty() {
        // jjwt throws IllegalArgumentException on null — provider must catch it.
