...
class TieredInterestStrategyTest {
    ...
    void tier_boundary_min_is_inclusive() {
        // principal == 1000 should hit the 0.015 tier (min inclusive), not 0.005 (max exclusive).
    ...
    void principal_below_lowest_tier_returns_zero() {
        ...
        // principal < min on the only tier → no matching tier → rate=0 → result=0
