...
/** Flat percentage with a minimum floor. Skipped for internal transfers. */
@Component
public class DomesticFeeStrategy implements FeeStrategy {
    ...
    public BigDecimal calculate(FeeCalculationContext ctx) {
        BigDecimal computed = ctx.getAmount().multiply(rate).setScale(4, RoundingMode.HALF_EVEN);
