...
/** Flat per-withdrawal fee, doubled on weekends. */
@Component
public class ATMWithdrawalFeeStrategy implements FeeStrategy {
    ...
    public BigDecimal calculate(FeeCalculationContext ctx) {
        return ctx.isWeekend() ? baseFee.multiply(weekendMultiplier) : baseFee;
    }
}
